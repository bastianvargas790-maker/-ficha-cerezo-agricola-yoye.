const CACHE='calicatas-campo-v20260921-kpitotal';
const SHELL=[
  './',
  './index.html',
  './registro.html',
  ...
  '../assets/calicatas.css?v=20260921-kpitotal',
  '../assets/supabase.js?v=20260921-kpitotal',
  '../assets/shared-auth.js?v=20260921-kpitotal',
  '../assets/calicatas.js?v=20260921-kpitotal',
  '../assets/yoye-logo-official.png?v=20260921-kpitotal',
