const CACHE='calicatas-campo-v20260924-auditoria';
const SHELL=[
  './',
  './index.html',
  './registro.html',
  ...
  '../assets/yoye-theme.css?v=20260924-auditoria',
  '../assets/private-app.css?v=20260924-auditoria',
  '../assets/campos.css?v=20260924-auditoria',
  '../assets/campos.js?v=20260924-auditoria',
  '../assets/aforo.js?v=20260924-auditoria',
  '../assets/calicatas.css?v=20260924-auditoria',
  '../assets/supabase.js?v=20260924-auditoria',
  '../assets/shared-auth.js?v=20260924-auditoria',
  '../assets/calicatas.js?v=20260924-auditoria',
  '../assets/calicatas-analisis.js?v=20260924-auditoria',
  '../assets/yoye-logo-official.png?v=20260924-auditoria',
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith(fetch(event.request).then(response=>{
    ...
    return response;
  }).catch(()=>caches.match(event.request).then(cached=>cached||(event.request.mode==='navigate'?caches.match('./registro-v16.html'):undefined))));
});
