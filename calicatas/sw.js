const CACHE='calicatas-campo-v20260921-guardar';
const SHELL=[
  './',
  './index.html',
  './registro.html',
  ...
  '../assets/calicatas.css?v=20260921-guardar',
  '../assets/supabase.js?v=20260921-guardar',
  '../assets/shared-auth.js?v=20260921-guardar',
  '../assets/calicatas.js?v=20260921-guardar',
  '../assets/yoye-logo-official.png?v=20260921-guardar',
