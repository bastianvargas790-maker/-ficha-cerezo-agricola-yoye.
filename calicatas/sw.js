const CACHE='calicatas-campo-v20260921-campo';
const SHELL=[
  './',
  './index.html',
  './registro.html',
  ...
  '../assets/calicatas.css?v=20260921-campo',
  '../assets/supabase.js?v=20260921-campo',
  '../assets/shared-auth.js?v=20260921-campo',
  '../assets/calicatas.js?v=20260921-campo',
  '../assets/yoye-logo-official.png?v=20260921-campo',
