const CACHE='calicatas-campo-v20260907-movil';
const SHELL=[
  './',
  './index.html',
  './registro.html',
  ...
  '../assets/calicatas.css?v=20260907-movil',
  '../assets/supabase.js?v=20260907-movil',
  '../assets/shared-auth.js?v=20260907-movil',
  '../assets/calicatas.js?v=20260907-movil',
  '../assets/yoye-logo-official.png?v=20260907-movil',
