const CACHE='yoye-shell-v18-shared-quarters';
const SHELL=['./','./index.html','./assets/private-app.css','./assets/app-enhancements-v3.css','./assets/app-enhancements-v3.js','./assets/supabase.js?v=20260819-supabase-local-1','./assets/shared-auth.js?v=20260819-shared-quarters-1','./assets/home-dashboard.js','./assets/field-map-data.js','./assets/quarter-dashboard.css','./assets/quarter-dashboard.js','./assets/calicatas.css?v=20260819-audit-2','./assets/calicatas.js?v=20260819-shared-quarters-1','./assets/yoye-logo.svg','./assets/icons/favicon.svg','./manifest.webmanifest','./calicatas/','./calicatas/index.html','./calicatas/registro.html','./calicatas/registro-v16.html','./cerezo/','./nogal/','./ciruelo/','./naranjo/','./duraznero/','./nectarino/','./cuarteles/'];
